...
mvn install:install-file -Dfile=../lib/contextnet-2.7-eSMA.jar -DgroupId=br.pro.turing -DartifactId=javino_stable -Dversion=2.7 -Dpackaging=jar -DgeneratePom=true
